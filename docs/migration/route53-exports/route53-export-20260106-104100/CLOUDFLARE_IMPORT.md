...
```bash
# Via API
curl -X POST "https://api.cloudflare.com/client/v4/zones"   -H "Authorization: Bearer $CF_API_TOKEN"   -H "Content-Type: application/json"   --data '{"name":"voulezvous.ai","account":{"id":"$CLOUDFLARE_ACCOUNT_ID"}}'
```
...
aws route53 get-hosted-zone --id Z08187493K05UXWL077NK
...
# aws route53 delete-hosted-zone --id Z08187493K05UXWL077NK
```
